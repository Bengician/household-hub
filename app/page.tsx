...
export default function Home() {
  ...
  const [isWakeUpPop, setIsWakeUpPop] = useState(true); // Triggers entrance animation on mount
  ...
  // Trigger wake-up pop animation once on initial mount
  useEffect(() => {
    const wakeTimer = setTimeout(() => {
      setIsWakeUpPop(false);
  ...
  const activeCapState = isListening || isWakeUpPop;
